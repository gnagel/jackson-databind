...
public final class DOMImplementationRegistry {
	...
	private static String getServiceValue(final ClassLoader classLoader) {
		...
		try {
			final InputStream is = getResourceAsStream(classLoader, serviceId);
			...
			if (is != null) {
				...
				final String serviceValue = rd.readLine();
				rd.close();
	 ...
	 * first checking the value of the Java system property <code>org.w3c.dom.DOMImplementationSourceList</code> and
	 ...
	 * names of availables classes implementing the <code>DOMImplementationSource</code> interface. Each class listed
	 ...
	 *             If any specified class does not implement <code>DOMImplementationSource</code>
	 */
	public static DOMImplementationRegistry newInstance()
		...
		if (p != null) {
			...
			while (st.hasMoreTokens()) {
				...
				final DOMImplementationSource source =
